...
from agrimask.utils.raster import write_raster
...
class Classifier:
    ...
    def lulc_cluster(self, layer_stack_path, date_band_ids, number_of_cluster=None):
        ...
        del labels
        outfile = os.path.join(out_dir, 'lulc_cluster.tif')
